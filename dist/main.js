(function () {
    ...
    ***************************************************************************** */
    ...
    `;
      ...
      `;
            ...
            const setVolume = (e) => {
                ...
                this.renderRoot.querySelector("#curr-volume").innerText = String(Math.ceil(newVol));
            };
            return $ `
      <svg
        id="background"
    ...
    __decorate([
        e$1({ type: Boolean, reflect: true, attribute: "settings-open" })
    ], AppView.prototype, "settingsOpen", void 0);
    AppView = __decorate([
        n$2("app-view")
    ], AppView);
